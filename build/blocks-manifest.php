...
return array(
	'category-carousel' => array(
		...
		'apiVersion' => 3,
		'name' => 'rp-multi-block/category-carousel',
		'version' => '0.1.0',
		'title' => 'Category Carousel',
		'category' => 'widgets',
		'icon' => 'carousel-view',
		'description' => 'Horizontal carousel of category cards with featured post images. Uses the Interactivity API.',
		'example' => array(
	...
	'mobile-menu-toggle' => array(
		...
		'category' => 'widgets',
		'icon' => 'menu',
		'description' => 'Hamburger toggle button that opens a mobile menu accordion panel. Uses the Interactivity API.',
		'example' => array(
